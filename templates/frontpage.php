                        ...
                        <div class="col-md-10">
                          <div class="topic-content pull-right">
                            ...
                            <div class="topic-info">
                              <a data-toggle="tooltip" data-placement="right" title="<?=getCategoryDes($topic->cat_id)?>" onmouseover='showdiscreption(<?=$topic->cat_id?>)' href="category.php?id=<?= urlformat($topic->cat_id)?>"><?=$topic->name?></a> >> <a href="topics.php?uid=<?= urlformat($topic->user_id);?>"><?=$topic->username?></a> >> <b>Posted on:</b> <?=dateFormat($topic->create_date)?>
